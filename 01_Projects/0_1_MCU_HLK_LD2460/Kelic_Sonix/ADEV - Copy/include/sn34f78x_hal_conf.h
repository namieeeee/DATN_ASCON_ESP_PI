 ...
 * @{
 */
#define configUSE_CRC_PERIPHERAL 1/**< 0: disable crc driver; 1: enable crc driver; default is 0 */
 ...
 * @{
 */
#define configUSE_TPM_PERIPHERAL 1 /**< 0: disable tpm driver; 1: enable tpm driver; default is 0 */
#if (configUSE_TPM_PERIPHERAL == 1)
// <e> Enable Callback
#define configUSE_TPM_REGISTER_CALLBACKS 1 /**< 0: disable CALLBACK API; 1: enable CALLBACK API; default is 0 */
// </e> Enable Callback
// <e> Enable PMW Function
#define configUSE_TPM_PWM 1 /**< 0: disable PWM API; 1: enable PWM API; default is 0 */
// </e> Enable PMW Function
// <e> Enable Output Compare Function
#define configUSE_TPM_OC 1 /**< 0: disable EMC API; 1: enable OC API; default is 0 */
// </e> Enable Output Compare Function
// <e> Enable Capture Function
#define configUSE_TPM_CAP 1/**< 0: disable CAP API; 1: enable CAP API; default is 0 */
// </e> Enable Capture Function
// <e> Enable DMA Function
#define configUSE_TPM_DMA 1 /**< 0: disable DMA API:; 1: enable DMA API; default is 0 */
// </e> Enable DMA Function
#include "hal_tpm.h"
#endif
/**
