...
/********************************************************************************/
			...
			GPIO1_PIN14_INIT.mode  = GPIO_MODE_INPUT;
...
/********************************************************************************/
			...
			GPIO1_PIN15_INIT.mode  = GPIO_MODE_INPUT;
			GPIO1_PIN15_INIT.pull = GPIO_PULL_UP;

			if (HAL_OK != HAL_GPIO_Init(SN_GPIO1, &GPIO1_PIN15_INIT))
					return HAL_ERROR;
			if (HAL_OK != HAL_GPIO_ConfigDebounce(SN_GPIO1, GPIO_PIN_14, ENABLE, 7))
					return HAL_ERROR;
			if (HAL_OK != HAL_GPIO_ConfigDebounce(SN_GPIO1, GPIO_PIN_15, ENABLE, 7))
					return HAL_ERROR;			
/********************************************************************************/
#endif
